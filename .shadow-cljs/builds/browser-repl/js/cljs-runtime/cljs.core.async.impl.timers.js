...
var i_21062 = (0);
while(true){
if((i_21062 < arr.length)){
(arr[i_21062] = null);

var G__21063 = (i_21062 + (1));
i_21062 = G__21063;
continue;
} else {
}
...
var i_21070 = (self__.level + (1));
while(true){
if((i_21070 <= (new_level + (1)))){
(update[i_21070] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_21072 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_21072[i]));
} else {
x__$2.forward.push((((i < links_21072.length))?(links_21072[i]):null));
}

if((i < links_21072.length)){
(links_21072[i] = x__$2);
} else {
links_21072.push(x__$2);
}
...
var i_21084 = (0);
while(true){
if((i_21084 <= self__.level)){
var links_21085 = (update[i_21084]).forward;
if((x__$1 === (((i_21084 < links_21085.length))?(links_21085[i_21084]):null))){
(links_21085[i_21084] = (x__$1.forward[i_21084]));

var G__21086 = (i_21084 + (1));
i_21084 = G__21086;
continue;
} else {
var G__21087 = (i_21084 + (1));
i_21084 = G__21087;
continue;
}
} else {
...
var G__21089 = nx;
var G__21090 = (level__$1 - (1));
x = G__21089;
level__$1 = G__21090;
continue;
} else {
var G__21091 = x;
var G__21092 = (level__$1 - (1));
x = G__21091;
level__$1 = G__21092;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__21094 = nx;
var G__21095 = (level__$1 - (1));
x = G__21094;
level__$1 = G__21095;
continue;
} else {
var G__21096 = x;
var G__21097 = (level__$1 - (1));
x = G__21096;
level__$1 = G__21097;
continue;
}
