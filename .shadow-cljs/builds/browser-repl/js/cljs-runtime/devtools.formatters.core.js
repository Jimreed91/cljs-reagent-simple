...
}catch (e19015){var _e__15647__auto__ = e19015;
return false;
...
}catch (e19017){var _e__15647__auto__ = e19017;
return false;
...
}catch (e19019){var _e__15647__auto__ = e19019;
return false;
...
}catch (e19021){var _e__15647__auto__ = e19021;
return false;
...
}catch (e19023){var _e__15647__auto__ = e19023;
return false;
}})())){
...
}catch (e19025){var _e__15647__auto__ = e19025;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__19027 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__19028 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__19028);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__19027);
}});
});
...
while (G__19031__i < G__19031__a.length) {G__19031__a[G__19031__i] = arguments[G__19031__i + 0]; ++G__19031__i;}
  args = new cljs.core.IndexedSeq(G__19031__a,0,null);
} 
...
var args = cljs.core.seq(arglist__19032);
