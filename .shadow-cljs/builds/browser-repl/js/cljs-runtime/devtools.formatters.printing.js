...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq18676){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18677,G__18678,seq18676__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__18694_SHARP_){
return (!((cljs.core.meta(p1__18694_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18701__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e18703){var _e__15647__auto__ = e18703;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e18708){var _e__15647__auto__ = e18708;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__18761 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__18762 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__18762);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18763__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__18761);
}});
...
var temp__5802__auto___18785 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___18785)){
var managed_print_level_18786 = temp__5802__auto___18785;
var _STAR_print_level_STAR__orig_val__18773_18787 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__18774_18788 = managed_print_level_18786;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__18774_18788);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__18765_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__18765_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__18773_18787);
}} else {
job_fn();
}
