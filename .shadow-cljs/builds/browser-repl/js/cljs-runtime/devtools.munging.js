...
var o18170 = temp__5802__auto__;
var temp__5802__auto____$1 = (o18170["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o18171 = temp__5802__auto____$1;
return (o18171["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15636__auto__ = f;
return (o__15636__auto__["toString"]).call(o__15636__auto__);
} else {
return "";
}
}catch (e18181){var _ = e18181;
return "";
}});
...
try{var o__15636__auto___18404 = t;
(o__15636__auto___18404["cljs$lang$ctorPrWriter"]).call(o__15636__auto___18404,t,writer);
}catch (e18187){var __18405 = e18187;
}
...
var char_code = (function (){var o__15636__auto__ = (new String(char$));
return (o__15636__auto__["charCodeAt"]).call(o__15636__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15636__auto__ = String;
return (o__15636__auto__["fromCharCode"]).call(o__15636__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18190 = num_code;
switch (G__18190) {
case (1):
return (185);
...
var o__15636__auto__ = String;
return (o__15636__auto__["fromCharCode"]).call(o__15636__auto__,superscript_code);
});
/**
...
}catch (e18221){var _e__15647__auto__ = e18221;
return false;
}})())){
...
var vec__18222 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18222,(0),null);
...
var len__5769__auto___18458 = arguments.length;
var i__5770__auto___18459 = (0);
while(true){
if((i__5770__auto___18459 < len__5769__auto___18458)){
args__5775__auto__.push((arguments[i__5770__auto___18459]));

var G__18460 = (i__5770__auto___18459 + (1));
i__5770__auto___18459 = G__18460;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18235){
var vec__18240 = p__18235;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18240,(0),null);
...
var G__18461 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__18462 = cljs.core.butlast(remaining_tokens);
name_tokens = G__18461;
remaining_tokens = G__18462;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18228){
var G__18229 = cljs.core.first(seq18228);
var seq18228__$1 = cljs.core.next(seq18228);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18229,seq18228__$1);
}));
...
var vec__18275 = cljs.core.split_with((function (p1__18274_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__18274_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18275,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18275,(1),null);
...
var vec__18281 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18281,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18281,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__18470 = cljs.core.rest(remaining_tokens);
var G__18471 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__18470;
name_tokens = G__18471;
continue;
} else {
...
var vec__18286 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18286,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18286,(1),null);
var vec__18289 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18289,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18289,(1),null);
var vec__18292 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18292,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18292,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18292,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18292,(3),null);
...
var vec__18307 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18307,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18307,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18307,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18307,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18307,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18307,(5),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18313,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18313,(1),null);
var vec__18316 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18316,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18316,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__18327 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__18327) : devtools.munging.parse_fn_info_deep.call(null,G__18327));
})()));
}
} else {
return fn_info;
...
var G__18487 = (arity + (1));
var G__18488 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18328){
var vec__18329 = p__18328;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18329,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18329,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18345_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__18345_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18346_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__18346_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18349){
var vec__18350 = p__18349;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18350,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18347){
var G__18348 = cljs.core.first(seq18347);
var seq18347__$1 = cljs.core.next(seq18347);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18348,seq18347__$1);
}));
...
var G__18353 = arg;
var G__18353__$1 = (((G__18353 instanceof cljs.core.Keyword))?G__18353.fqn:null);
switch (G__18353__$1) {
...
var map__18364 = options;
var map__18364__$1 = cljs.core.__destructure_map(map__18364);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18364__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18364__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18364__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18364__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18365 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18365,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18365,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18365,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18365,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18365,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18365,(5),null);
...
var o__15636__auto__ = f;
return (o__15636__auto__["getBasis"]).call(o__15636__auto__);
});
/**
...
}catch (e18368){var _e__15647__auto__ = e18368;
...
var G__18516 = (obj[cljs.core.first(path)]);
var G__18517 = cljs.core.rest(path);
obj = G__18516;
path = G__18517;
continue;
} else {
...
var _STAR_ = (function (accum,p__18370){
var vec__18371 = p__18370;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18371,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18371,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18374){
var vec__18375 = p__18374;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18375,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18375,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18375,(2),null);
...
var post_process = (function (p__18379){
var vec__18380 = p__18379;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18380,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18380,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18378_SHARP_){
return (obj[cljs.core.first(p1__18378_SHARP_)]);
}),sorted_matches);
