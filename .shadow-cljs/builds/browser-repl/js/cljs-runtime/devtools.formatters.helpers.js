...
var G__18529 = devtools.prefs.pref(v);
v = G__18529;
continue;
} else {
return v;
...
}catch (e18421){var _e__15647__auto__ = e18421;
return false;
}})();
...
}catch (e18431){var _e__15647__auto__ = e18431;
return false;
}})();
...
}catch (e18433){var _e__15647__auto__ = e18433;
return false;
}}
}
});
...
var vec__18481 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18481,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18481,(1),null);
...
return cljs.core.some((function (p1__18496_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18496_SHARP_);
}),template);
});
