...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19143 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19143(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19144 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19144(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19145 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19145(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19146 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19146(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19147 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19147(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19148 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19148(reader);
}
});
...
var G__19157 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19158 = s.append(c);
c = G__19157;
s = G__19158;
continue;
}
