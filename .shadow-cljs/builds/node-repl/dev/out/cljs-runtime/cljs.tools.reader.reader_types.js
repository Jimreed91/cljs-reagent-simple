...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14748 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14748(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14750 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14750(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14751 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14751(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14752 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14752(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14756 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14756(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14757 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14757(reader);
}
});
...
var G__14798 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14799 = s.append(c);
c = G__14798;
s = G__14799;
continue;
}
